...
CREATE TABLE `nota` (
  ...
  PRIMARY KEY (`id_nota`),
  KEY `fk_id_aluno_curso_idx` (`id_aluno_nota`)
...
INSERT INTO `nota` VALUES (1,0,'Atividade individual',30.00),(2,0,'avaliação 1',40.00),(3,0,'avaliação 2',20.00),(4,0,'avaliação 3',10.00);
